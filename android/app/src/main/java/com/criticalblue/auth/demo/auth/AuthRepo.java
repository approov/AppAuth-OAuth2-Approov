...
public class AuthRepo {
    ...
    private void performCodeExchangeRequest(AuthorizationResponse resp) {
        ...
        // UNCOMMENT ONLY WHEN WANTING TO TEST THE WEB FLOW QWITHOUT APPROOV
        // performWebFlowTokenRequest(resp);

        // *** UNCOMMENT THE LINE BELOW FOR APPROOV ***
        // performWebFlowTokenRequestWithApproov(resp);
    }
    ...
    private void performWebFlowTokenRequest(AuthorizationResponse resp) {
        ClientAuthentication clientAuth = new ClientSecretPost(app.getString(R.string.client_secret));
    ...
    private void performWebFlowTokenRequestWithApproov(AuthorizationResponse resp) {
